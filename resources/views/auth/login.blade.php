...
<head>
    ...
    <meta name="author" content="M-IT Solution">
...
<section>
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-5"><img class="bg-img-cover bg-center" src="{{ asset('assets/backend/images/login_image.jpg') }}" alt="loginpage">
            </div>
            <div class="col-xl-7 p-0">
                <div class="login-card">
                    ...
                    <form class="theme-form login-form" action="{{ route('login') }}" method="post">
                        ...
                        <div class="pt-4">
                            <p>Developed by <a href="https://www.m-itsolution.com/" target="_blank">M-IT Solution</a></p>
                        </div>
